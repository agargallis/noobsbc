...
function CookieIcon() {
  return (
    <svg className="cookie-icon-svg" viewBox="0 0 56 56" fill="none" aria-hidden="true">
      ...
      <ellipse cx="19" cy="22" rx="3.4" ry="2.8" fill="#f4c63d" opacity="0.9" transform="rotate(-20 19 22)" />
      <ellipse cx="34" cy="19" rx="3" ry="2.4" fill="#f4c63d" opacity="0.9" transform="rotate(12 34 19)" />
      <ellipse cx="22" cy="35" rx="3.2" ry="2.6" fill="#f4c63d" opacity="0.9" transform="rotate(8 22 35)" />
      <ellipse cx="36" cy="33" rx="2.8" ry="2.2" fill="#f4c63d" opacity="0.9" transform="rotate(-10 36 33)" />
      <ellipse cx="14" cy="33" rx="2.4" ry="2" fill="#f4c63d" opacity="0.9" />
      <ellipse cx="29" cy="42" rx="2.6" ry="2.1" fill="#f4c63d" opacity="0.9" transform="rotate(5 29 42)" />
    </svg>
  );
}
